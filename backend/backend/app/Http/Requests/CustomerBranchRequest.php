...
class CustomerBranchRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sales_account' => 'required|string|max:15',
            'sales_discount_account' => 'required|string|max:15',
            'receivables_account' => 'required|string|max:15',
            'payment_discount_account' => 'required|string|max:15',
            ...
            'inactive' => 'boolean',
            'contact_person' => 'required|string|max:60',
        ];
    }
}
