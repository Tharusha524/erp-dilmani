...
{   
    private InventoryLocationInterface $repo;

    public function __construct(InventoryLocationInterface $repo)
    {
        $this->repo = $repo;
    }
    /**
    ...
    {
        $InventoryLocation = $this->repo->create($request->validated());
        return response()->json($InventoryLocation, 201);  
    }
     ...
     */
    public function update(InventoryLocationRequest $request, string $id)
    {
