...
export async function getMedicineInventoriesList() {
  const res = await api.get("/medicine-inventory");
  return res.data;
}

export async function getMedicineInventoriesTransaction() {
  const res = await api.get("/transaction-published");
  return res.data;
}
...
export const createMedicineInventory = async (
  ...
  const res = await api.post("/medicine-inventory", formData, {
    headers: {
...
export const updateMedicineInventory = async (
  ...
  const res = await api.post(
    `/medicine-inventory/${medicineInventory.id}/update`,
    formData,
    {
      headers: {
        "Content-Type": "multipart/form-data",
...
export const publishMedicineInventory = async (
  ...
  const res = await api.post(
    `/medicine-inventory/${medicineInventory?.id}/publish`,
    formData,
    {
      headers: {
        "Content-Type": "multipart/form-data",
...
export const deleteMedicineInventory = async (id: string) => {
  const res = await api.delete(`/medicine-inventory/${id}/delete`);
  return res.data;
};
