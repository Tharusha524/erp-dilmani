...
export async function getAccidentsAssignedTaskList() {
  const res = await api.get("/accidents-assign-task");
  return res.data;
}
...
export const createAccident = async (accident: Accident) => {
  ...
  const res = await api.post("/accidents", formData, {
    headers: {
...
export const deleteAccident = async (id: string) => {
  const res = await api.delete(`/accidents/${id}/delete`);
  return res.data;
};
...
export async function getIncidentsAssignedTaskList() {
  const res = await api.get("/incidents-assign-task");
  return res.data;
}
...
export const deleteIncident = async (id: string) => {
  const res = await api.delete(`/incidents/${id}/delete`);
  return res.data;
}; //push
