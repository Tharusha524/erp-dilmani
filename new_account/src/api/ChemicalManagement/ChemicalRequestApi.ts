...
export async function fetchChemicalRequests() {
  const res = await api.get(`/chemical-records`);
  return res.data;
}

export async function fetchChemicalCommercialNames() {
  const res = await api.get(`/commercial-names`);
  return res.data;
}

export async function createChemical(data: { data: Partial<Chemical> }) {
  const res = await api.post(`/commercial-names`, {
    ...data,
  });
  return res.data;
}
...
export async function createProductStandard(data: {
  ...
  const res = await api.post(`/product-standard`, {
    ...data,
  });
  return res.data;
}
...
export async function fetchProductStandards() {
  const res = await api.get(`/product-standard`);
  return res.data;
}
...
export const createChemicalRequest = async ({
  ...
  try {
    const response = await api.post(`/chemical-records`, formData, {
...
export const updateChemicalRequest = async ({
  ...
  try {
    const response = await api.post(
      `/chemical-records/${data.id}/update`,
      formData,
      { headers: { "Content-Type": "multipart/form-data" } }
    );
...
export const approveChemicalRequest = async ({
  ...
  try {
    const response = await api.post(
      `/chemical-records/${data.id}/approve`,
      formData,
      { headers: { "Content-Type": "multipart/form-data" } }
    );
...
export const deleteChemicalRequest = async (id: string) => {
  const res = await api.delete(`/chemical-records/${id}/delete`);
  return res.data;
};

export async function fetchChemicalPurchaceInventories() {
  const res = await api.get(`/purchase-inventory-records`);
  return res.data;
}

export async function fetchAllSupplierNames() {
  const res = await api.get("/chemical-supplier-names");
  return res.data;
}

export async function fetchTestingLabsData() {
  const res = await api.get("/testing-labs");
  return res.data;
}

export async function createTestLab(data: Partial<ChemicalTestLab>) {
  const res = await api.post("/testing-labs", data);
  return res.data;
}

export async function fetchPositiveList() {
  const res = await api.get("/positive-list");
  return res.data;
}
...
export async function createPositiveList(
  ...
  const res = await api.post("/positive-list", data);
  return res.data;
}
...
export const updateChemicalPurchaseInventory = async (
  ...
  const res = await api.post(
    `/purchase-inventory-records/${chemicalPurchaseInventory.id}/update`,
    formData,
    {
      headers: {
...
export const publishChemicalPurchase = async (
  ...
  const res = await api.post(
    `/purchase-inventory-records/${chemicalPurchaseInventory.id}/publish-update`,
    formData,
    {
      headers: {
        "Content-Type": "multipart/form-data",
...
export const deleteChemicalPurchaseRequest = async (id: string) => {
  console.log("id", id);
  const res = await api.delete(`/purchase-inventory-record/${id}/delete`);
  return res.data;
};

export async function fetchChemicalTransactionPublished() {
  const res = await api.get(`/chemical-transaction-published`);
  return res.data;
}

export async function fetchChemicalAssignedRequest() {
  const res = await api.get(`/purchase-inventory-records-assign-task`);
  return res.data;
}
