...
export async function getInternalAuditList() {
  const res = await api.get("/internal-audit");
  return res.data;
}
...
export const updateInternalAudit = async (
  ...
  const res = await api.post("/internal-audit", formData, {
    headers: {
...
export const deleteInternalAudit = async (id: number) => {
  const res = await api.delete(`/internal-audit/${id}/delete`);
  return res.data;
};
...
export async function createInternalAuditForm(data: Partial<InternalAudit>) {
  const res = await api.post("/question-reports", {
    ...data,
  });
  return res.data;
}
...
export async function updateInternalAuditForm({
  ...
  const res = await api.post(`/question-reports/${id}/update`, {
    ...data,
  });
  return res.data;
}
...
export async function deleteInternalAuditForm({ id }: { id: string }) {
  const res = await api.delete(`/question-reports/${id}/delete`);
  return res.data;
}
...
export async function createDraftScheduledInternalAudit(
  ...
  const res = await api.post("/internal-audit-draft", {
    ...data,
  });
  return res.data;
}
...
export async function updateDraftScheduledInternalAudit(
  ...
  const res = await api.post(`/internal-audit-draft/${data.id}/update`, {
    ...data,
  });
  return res.data;
}
...
export async function createScheduledInternalAudit(
  ...
  const res = await api.post("/internal-audit-scheduled", {
    ...data,
  });
  return res.data;
}
...
export async function updateScheduledInternalAudit(
  ...
  const res = await api.post(
    `/internal-audit-scheduled/${data.id}/update`,
    {
      ...data,
    }
  );
...
export async function updateOngoingInternalAudit(
  ...
  const res = await api.post(
    `/internal-audit-ongoing/${data.id}/update`,
    {
      ...data,
    }
  );
...
export async function completeInternalAudit(
  ...
  const res = await api.post(
    `/internal-audit-completed/${data.id}/update`,
    {
      ...data,
    }
  );
...
export async function createActionPlan(
  ...
  const res = await api.post(`/internal-audit-action-plan`, {
    ...data,
  });
  return res.data;
}
...
export async function updateActionPlan(
  ...
  const res = await api.post(
    `/internal-audit-action-plan/${data.actionPlanId}/update`,
    {
      ...data,
    }
  );
...
export async function deleteActionPlan({ id }: { id: string }) {
  const res = await api.delete(
    `/internal-audit-action-plan/${id}/delete`
  );
  return res.data;
}
