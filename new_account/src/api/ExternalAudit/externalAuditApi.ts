...
export const updateExternalAudit = async (externalAudit: ExternalAudit) => {
  ...
  try {
    const response = await api.post(
      `/external-audit/${externalAudit.id}/update`,
      formData,
...
export async function deleteExternalAudit(id: number) {
  const res = await api.delete(`/external-audit/${id}/delete`);
}
export async function getExternalAuditData() {
  const res = await api.get("/external-audit");
  return res.data;
}
export async function getExternalAssignedAudit() {
  const res = await api.get("/external-audit-assign-task");
  return res.data;
}
...
export const createExternalAudit = async (externalAudit: ExternalAudit) => {
  ...
  const res = await api.post("/external-audit", formData, {
    headers: {
...
export async function fetchAuditType() {
  const res = await api.get("/external-audit-type");
  return res.data;
}

export async function fetchAuditCategory() {
  const res = await api.get("/external-audit-category");
  return res.data;
}

export async function fetchAuditStandard() {
  const res = await api.get("/external-audit-standard");
  return res.data;
}

export async function fetchAuditFirm() {
  const res = await api.get("/external-audit-firm");
  return res.data;
}
...
export async function createExternalActionPlan(
  ...
  const res = await api.post(`/external-audit-action-plan`, {
    ...data,
  });
  return res.data;
}
...
export async function updateExternalActionPlan(
  ...
  const res = await api.post(
    `/external-audit-action-plan/${data.actionPlanId}/update`,
    {
      ...data,
    }
  );
...
export async function deleteExternalActionPlan({ id }: { id: string }) {
  const res = await api.delete(
    `/external-audit-action-plan/${id}/delete`
  );
  return res.data;
}
