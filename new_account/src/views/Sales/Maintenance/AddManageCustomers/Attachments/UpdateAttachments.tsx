...
import { updateEntityAttachment } from "../../../../../api/Attachments/AttachmentsApi";
...
export default function UpdateAttachmentsForm() {
  ...
  const validate = () => {
    ...
    if (!formData.attachmentId.trim()) newErrors.attachmentId = "Attachment ID is required";
  ...
  const handleSubmit = async () => {
    if (validate()) {
      ...
      try {
        ...
        await updateEntityAttachment(Number(formData.attachmentId), formDataObj);
        ...
        setErrorMessage(
          ...
          "Failed to update attachment. Please try again."
        );
        setErrorOpen(true);
      ...
      >
        ...
        <Stack spacing={2}>
          ...
          <TextField
            ...
            helperText={errors.attachmentId || " "}
          />
