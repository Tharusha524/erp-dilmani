...
export default function UpdatedSalesQuotationEntrySuccess() {
    ...
    <Stack spacing={2}>
      ...
      <Paper sx={{ p: 2 }}>
        <Typography sx={{ mb: 2, textAlign: 'center' }}>
          Quotation #{orderNo || ''} has been updated.
        </Typography>
        ...
        <Stack spacing={3} direction="column" alignItems="center">
          ...
          <Button
            variant="outlined"
            sx={{ width: '300px' }}
            onClick={() => navigate("/sales/inquiriesandreports/sales-quotation-inquiry")}
          >
