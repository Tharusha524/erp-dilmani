...
export default function CreditInvoiceSuccess() {
            ...
            <Paper sx={{ p: 2 }}>
                ...
                <Stack spacing={3} direction="column" alignItems="center">
                    <Button
                        variant="outlined"
                        sx={{ width: '300px' }}
                        onClick={() => navigate("/sales/transactions/credit-invoice/view-credit-invoice", { state: { ...state, ...glState } })}
                    >
                    ...
                    <Button
                        ...
                        sx={{ width: '300px' }}
                        onClick={() =>
                            navigate("/sales/transactions/credit-invoice/view-credit-invoice", {
                                state: { ...state, ...glState, autoPrint: true },
                            })
                        }
                    >
