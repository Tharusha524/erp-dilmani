...
interface PrintReceiptsFormData {
    from: string;
    to: string;
...
export default function PrintReceiptsForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<PrintReceiptsFormData>({
        from: "",
        to: "",
        email: "No",
    ...
    const [errors, setErrors] = useState<Partial<PrintReceiptsFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<PrintReceiptsFormData> = {};
