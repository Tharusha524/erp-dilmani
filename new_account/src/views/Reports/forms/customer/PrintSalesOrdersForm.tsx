...
interface PrintSalesOrdersFormData {
    from: string;
    to: string;
...
export default function PrintSalesOrdersForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<PrintSalesOrdersFormData>({
        from: "",
        to: "",
        email: "No",
        quote: "No",
    ...
    const [errors, setErrors] = useState<Partial<PrintSalesOrdersFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<PrintSalesOrdersFormData> = {};
