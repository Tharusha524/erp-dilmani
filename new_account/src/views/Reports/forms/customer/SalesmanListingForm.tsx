...
interface SalesmanListingFormData {
    startDate: string;
    endDate: string;
    summary: string;
    comments: string;
...
export default function SalesmanListingForm() {
    ...
    const [formData, setFormData] = useState<SalesmanListingFormData>({
        startDate: "",
        endDate: "",
        summary: "No",
        comments: "",
    ...
    const [errors, setErrors] = useState<Partial<SalesmanListingFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<SalesmanListingFormData> = {};
