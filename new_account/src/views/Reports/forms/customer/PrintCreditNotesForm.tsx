...
interface PrintCreditNotesFormData {
    from: string;
    to: string;
...
export default function PrintCreditNotesForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<PrintCreditNotesFormData>({
        from: "",
        to: "",
        customer: "NoFilter",
        email: "No",
    ...
    const [errors, setErrors] = useState<Partial<PrintCreditNotesFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<PrintCreditNotesFormData> = {};
