...
interface SupplierTrialBalancesFormData {
  startDate: string;
  endDate: string;
  supplier: string;
...
export default function SupplierTrialBalancesForm() {
  const muiTheme = useTheme();
  const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

  const [formData, setFormData] = useState<SupplierTrialBalancesFormData>({
    startDate: "",
    endDate: "",
    supplier: "NoFilter",
  ...
  const [errors, setErrors] = useState<Partial<SupplierTrialBalancesFormData>>({});
  ...
  // Simple validation
  const validate = () => {
    let newErrors: Partial<SupplierTrialBalancesFormData> = {};
