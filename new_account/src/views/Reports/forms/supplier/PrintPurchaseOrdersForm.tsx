...
interface PrintPurchaseOrdersFormData {
    from: string;
    to: string;
...
export default function PrintPurchaseOrdersForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<PrintPurchaseOrdersFormData>({
        from: "",
        to: "",
        email: "No",
    ...
    const [errors, setErrors] = useState<Partial<PrintPurchaseOrdersFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<PrintPurchaseOrdersFormData> = {};
