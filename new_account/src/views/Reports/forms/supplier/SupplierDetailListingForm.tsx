...
interface SupplierDetailListingFormData {
    startDate: string;
...
export default function SupplierDetailListingForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<SupplierDetailListingFormData>({
        startDate: "",
        actGreaterThan: "",
        actLessThan: "",
        comments: "",
    ...
    const [errors, setErrors] = useState<Partial<SupplierDetailListingFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<SupplierDetailListingFormData> = {};
