...
interface PrintRemittancesFormData {
    from: string;
    to: string;
...
export default function PrintRemittancesForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<PrintRemittancesFormData>({
        from: "",
        to: "",
        email: "No",
    ...
    const [errors, setErrors] = useState<Partial<PrintRemittancesFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<PrintRemittancesFormData> = {};
