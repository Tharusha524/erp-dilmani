...
interface CostedInventoryMovementReportFormData {
    startDate: string;
    endDate: string;
    itemCategory: string;
    location: string;
...
export default function CostedInventoryMovementReportForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<CostedInventoryMovementReportFormData>({
        startDate: "",
        endDate: "",
    ...
    const [errors, setErrors] = useState<Partial<CostedInventoryMovementReportFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<CostedInventoryMovementReportFormData> = {};
