...
interface InventoryMovementReportFormData {
    startDate: string;
    endDate: string;
    itemCategory: string;
    location: string;
...
export default function InventoryMovementReportForm() {
    const muiTheme = useTheme();
    const isMobile = useMediaQuery(muiTheme.breakpoints.down("sm"));

    const [formData, setFormData] = useState<InventoryMovementReportFormData>({
        startDate: "",
        endDate: "",
    ...
    const [errors, setErrors] = useState<Partial<InventoryMovementReportFormData>>({});
    ...
    // Simple validation
    const validate = () => {
        let newErrors: Partial<InventoryMovementReportFormData> = {};
