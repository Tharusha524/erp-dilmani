...
export default function DimensionInquiry() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      console.error("Dimension inquiry search failed:", error);
      setRows([]);
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Stack spacing={2}>
      ...
      >
        <Box>
          <PageTitle title="Search Dimensions" />
          <Breadcrumb
            breadcrumbs={[
              { title: "Home", href: "/dashboard" },
              { title: "Dimensions", href: "/dimension/inquiriesandreports" },
              { title: "Dimension Inquiry" },
            ]}
          />
        </Box>
            ...
            {paginatedRows.length === 0 && !isLoading && (
              <TableRow>
                <TableCell colSpan={9} align="center">
                  No dimensions found. Run a search or add a dimension entry.
                </TableCell>
              </TableRow>
            )}
            {paginatedRows.map((r) => (
